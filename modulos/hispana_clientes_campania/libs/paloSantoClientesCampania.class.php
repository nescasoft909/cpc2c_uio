...
class paloSantoClientesCampania{
    ...
    function getNumClientesCampania($filter_field, $filter_value)
    {
        ...
        $query   = "SELECT COUNT(*) FROM _view_clientes_campania $where";
    ...
    function getClientesCampania($limit, $offset, $filter_field, $filter_value)
    {
        ...
        $query   = "SELECT * FROM _view_clientes_campania $where LIMIT $limit OFFSET $offset";
    ...
    {
	$query = "SELECT * from _view_clientes_campania 
