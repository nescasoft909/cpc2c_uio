<?php
  ...
  +----------------------------------------------------------------------+
  $Id: index.php,v 1.1 2012-04-12 03:04:14 Juan Pablo Romero jromero@palosanto.com Exp $ */
...
function _moduleContent(&$smarty, $module_name)
{
    ...
    include_once "modules/$module_name/libs/paloSantoReporteGeneraldeGestion.class.php";
    ...
    switch($action){
        default:
            $content = reportReporteGeneraldeGestión($smarty, $module_name, $local_templates_dir, $pDB, $arrConf);
            break;
    }
    return $content;
}
