...
<form method=post>
  <tr width="100%" align="center">
    <td align="left" width="25%"><font size=2><b>Campañas</b></td>
    <td align="left">
      <select name="campania" id="select_campanias" onchange="selectCampania();">
	<option value=0>-- Campañas --</option>
	{html_options options=$CAMPANIAS_OPTIONS selected=$CAMPANIA_ID}
      </select>
    </td>
  </tr>
  <tr width="100%" align="center">
    <td align="left" width="25%"><font size=2><b>Agentes</b></td>
    <td align="left"><select name="agente" id="select_agentes"></select></td>
  </tr>  
  <tr width="100%" align="center">
