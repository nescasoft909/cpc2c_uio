<?php
  ...
  +----------------------------------------------------------------------+
  $Id: index.php,v 1.1 2012-03-22 09:03:45 Manuel Vera manuel.vera@aplisoft.com.ec Exp $ */
...
function viewFormCrearcampaña($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf)
{
    ...
    $htmlForm = $oForm->fetchForm("$local_templates_dir/form.tpl",_tr("Campaña Recargable"), $_DATA);
...
{
    $campaña=$_POST;
    //$campaña["fecha_inicio"]=$_POST["fecha"]."-01-01";
    //$campaña["fecha_fin"]=$_POST["fecha"]."-12-31";
    //print_r($campaña);
    //exit(1);
    $pCrearcampaña = new paloSantoCrearcampaña($pDB);
    $arrFormCrearcampaña = createFieldForm($pDB);
	...
	$msg = $pCrearcampaña->guardarCampaña($campaña); 
