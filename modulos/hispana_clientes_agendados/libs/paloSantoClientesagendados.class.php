...
class paloSantoClientesagendados{
    var $_DB;
    var $errMsg;

    function paloSantoClientesagendados(&$pDB)
    {
    ...
    function getNumClientesagendados($filter_field, $filter_value)
    {
        $where    = "";
        $arrParam = null;
        ...
        $query   = "SELECT COUNT(*) FROM _view_clientes_agendados $where";
    ...
    function getClientesagendados($limit, $offset, $filter_field, $filter_value)
    {
        $where    = "";
        $arrParam = null;
        if(isset($filter_field) & $filter_field !=""){
        ...
        $query   = "SELECT * FROM _view_clientes_agendados $where LIMIT $limit OFFSET $offset";
    ...
    function reasignarAgenteAgendadoRecargable($id_campania_cliente,$agente)
    {
