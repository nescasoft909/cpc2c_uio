<?php
  ...
  +----------------------------------------------------------------------+
  $Id: index.php,v 1.1 2012-04-29 04:04:10 Juan Pablo Romero jromero@palosanto.com Exp $ */
...
function _moduleContent(&$smarty, $module_name)
{
    ...
    include_once "modules/$module_name/libs/paloSantoIngresodeotrosdatos.class.php";
    ...
    switch($action){
        case "save_new":
            $content = saveNewIngresodeotrosdatos($smarty, $module_name, $local_templates_dir, $pDB, $arrConf);
            break;
        default: // view_form
...
function viewFormIngresodeotrosdatos($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf)
{
    ...
    if($action=="view" || $action=="view_edit"){ // the action is to view or view_edit.
        $dataIngresodeotrosdatos = $pIngresodeotrosdatos->getIngresodeotrosdatosById($id);
    ...
    $htmlForm = $oForm->fetchForm("$local_templates_dir/form.tpl",_tr("Ingreso de otros datos"), $_DATA);
