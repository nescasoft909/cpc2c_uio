...
function _moduleContent(&$smarty, $module_name)
{
  ...
  /** 
    ...
    */
    ...
    if(isset($_GET['siguiente']) && $_GET['siguiente']=="si") unset($_SESSION['id_campania_cliente']);
...
function mostrarDatosClienteHTML($smarty, $pInterfazdeAgente)
{
    ...
    $arrGestionesPrevias = $pInterfazdeAgente->getGestionesPrevias($arrInfoCliente['ci'],$arrInfoCliente['id_campania_consolidada']);
